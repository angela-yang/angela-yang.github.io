...
const counters = [
  { element: '.counter:nth-child(1) .count', start: 0, end: 18000, duration: 500 },
  { element: '.counter:nth-child(2) .count', start: 0, end: 17000, duration: 500 },
  { element: '.counter:nth-child(3) .count', start: 0, end: 45000000000, duration: 500 }
];

counters.forEach(counter => {
  animateValue(counter.element, counter.start, counter.end, counter.duration);
});
